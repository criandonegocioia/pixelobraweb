...
const IMAGES = {
    ideia1: "https://d2xsxph8kpxj0f.cloudfront.net/310519663329410379/6BCWYzW7mGqgAm22TjZhXb/ideia1_e773e583.jpg",
    ideia2: "/images/decora/ideia2.jpg",
    ideia3: "/images/decora/ideia3.jpg",
    projeto1: "/images/decora/projeto1.jpg",
    projeto2: "/images/decora/projeto2.jpg",
    projeto3: "/images/decora/projeto3.jpg",
};
...
export default function Decora() {
    const { language } = useLanguage();
    const t = translations[language].decora; // Using decora key
