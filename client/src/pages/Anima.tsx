...
const IMAGES = {
    ideia1: "/images/anima/ideia1.jpg",
    ideia2: "/images/anima/ideia2.jpg",
    ideia3: "/images/anima/ideia3.jpg",
    ideia4: "/images/anima/ideia4.jpg",
    ideia5: "/images/anima/ideia5.jpg",
};
...
export default function Anima() {
    ...
    const t = translations[language].anima; // Using anima key
        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="pb-24 px-6">
                <div className="container">
                    ...
                    {/* Second Section Title & Disclaimer */}
                    <div className="mb-16">
                    ...
                    >
                        {ANIMA_VIDEOS.map((videoSrc, index) => {
                            const VIDEO_COLORS = [
                                "border-blue-500",
                                "border-emerald-500",
                                "border-amber-500",
                            ...
                            return (
                                <motion.div
                                    key={index}
                                    variants={fadeInUp}
                                    className="w-full max-w-[280px] sm:max-w-[300px] flex-none flex flex-col items-center"
                                >
                                    <PhoneMockup
                                        videoSrc={videoSrc}
                                        poster="/images/PO.jpeg"
                                        frameColorClassName={VIDEO_COLORS[index]}
                                    />
                                    <p className="mt-6 text-xl font-semibold text-foreground text-center">
