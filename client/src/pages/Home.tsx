    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <nav className="container relative flex items-center justify-between h-16 md:h-20">
        ...
        <a href="/" className="flex items-center gap-2 group">
          ...
          <span className="text-lg font-semibold tracking-tight">PIXEL OBRA</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Button size="sm" className="bg-primary hover:bg-primary/90 text-primary-foreground" onClick={handleNavClick}>
            Começar Agora
          </Button>
        </div>
        ...
        >
          <div className="container py-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 pt-2 border-t border-white/5">
              ...
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground" onClick={handleNavClick}>
                Começar Agora
              </Button>
            </div>
          </div>
