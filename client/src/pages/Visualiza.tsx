...
const IMAGES = {
    ideia1: "/images/visualizacao/ideia1.jpg",
    ideia2: "/images/visualizacao/ideia2.jpg",
    ideia3: "/images/visualizacao/ideia3.jpg",
    projeto1: "/images/visualizacao/projeto1.jpg",
    projeto2: "https://d2xsxph8kpxj0f.cloudfront.net/310519663329410379/6BCWYzW7mGqgAm22TjZhXb/projeto2_0b1a46d7.jpg",
...
export default function Visualiza() {
    const { language } = useLanguage();
    const t = translations[language].visualiza; // Using visualiza key
