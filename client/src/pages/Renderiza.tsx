...
/**
 * Renderiza Page - Galeria de Projetos de Renderização da Pixel Obra
...
const RENDERIZA_IMAGES = {
  ...
  ideia1: "https://d2xsxph8kpxj0f.cloudfront.net/310519663329410379/6BCWYzW7mGqgAm22TjZhXb/ideia3_d392bbb4.jpeg",
  ideia2: "/images/renderizacao/ideia2.jpeg",
  projeto2: "/images/renderizacao/render2.jpeg",
  projeto3: "/images/renderizacao/render1.jpeg",
  ideia3: "/images/renderizacao/ideia1.jpeg",
  logopo: "/images/PO.jpeg",
};

const PROJECT_IMAGES: Record<number, string> = {
  1: RENDERIZA_IMAGES.ideia3,
  2: RENDERIZA_IMAGES.ideia2,
  3: RENDERIZA_IMAGES.ideia1,
  4: RENDERIZA_IMAGES.projeto2,
  5: RENDERIZA_IMAGES.projeto3,
  6: RENDERIZA_IMAGES.projeto1,
  7: RENDERIZA_IMAGES.logopo,
};
...
export default function Renderiza() {
  ...
  const t = translations[language].renderiza;
