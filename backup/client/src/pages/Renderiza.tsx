...
export default function Renderiza() {
    ...
    const tTools = translations[language].tools;
    ...
    const categories = [t.categories.all, t.categories.exterior, t.categories.interior, t.categories.virtual];
        ...
        <div className="min-h-screen bg-background">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4" style={glassCardStyle}>
                <div className="container flex items-center justify-between">
                    ...
                    <h1 className="text-xl font-semibold text-foreground">{tTools.items.render.title}</h1>
