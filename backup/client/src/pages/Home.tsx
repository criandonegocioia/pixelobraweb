    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-20">
        ...
        >
          ...
          >
            {t.title} <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-amber-400">{t.subtitle}</span>
          </h1>
      ...
      <div className="container relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">
            {t.title} <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-amber-400">{t.highlight}</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-3xl md:text-5xl font-bold tracking-tight mb-6">
              {t.title}{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-amber-400">{t.highlight}</span>
            </motion.h2>
          ...
          >
            ...
            <div className="absolute -bottom-4 -left-4 px-4 py-2 rounded-xl" style={glassCardStyle}>
              <p className="text-xs text-muted-foreground">{t.floatingBadge.text}</p>
              <p className="text-lg font-semibold text-primary">{t.floatingBadge.cta}</p>
            </div>
          </motion.div>
        </div>
      </div>
